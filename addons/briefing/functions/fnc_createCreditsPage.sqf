...
_text = _text + "<br/><br/><font size='12'>This mission was created using MRE (Mission Ready Environment).<br/>MRE Mod v" + getText (ConfigFile >> "CfgPatches" >> "tmf_main" >> "versionStr") + "<br/>MRE Mission Template v" + (getMissionConfigValue ["tmf_version",[0,0,0]] joinString ".") + "</font>";
